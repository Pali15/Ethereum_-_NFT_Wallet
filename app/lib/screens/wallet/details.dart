...
import 'package:app/components/custom_future_builder.dart';
import 'package:app/constants/app_routes.dart';
import 'package:app/constants/colors.dart';
import 'package:app/constants/text_styles.dart';
import 'package:app/constants/time_formats.dart';
...
class WalletDetails extends StatelessWidget {
        ...
        builder: (context) {
          return Column(
            ...
            children: [
              ...
              const Divider(
                color: CustomColors.background_2,
                thickness: 1,
              ),
              Row(
                children: [
  ...
  Widget _buildCard() {
    return CustomFutureBuilder<BigInt>(
          ...
          return Container(
            ...
            decoration: const BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  CustomColors.background_1,
                  CustomColors.background_2,
